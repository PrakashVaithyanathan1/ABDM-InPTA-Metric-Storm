...
Signature_14639.py: This is the primary empirical engine. It performs the high-cadence spectral analysis on the InPTA DR2 residuals to extract the definitive 1.4639 alpha-signature. This script identifies the "Inertial Range" of the Metric Storm, providing the specific value required to reconcile the 5-sigma Hubble Tension.
